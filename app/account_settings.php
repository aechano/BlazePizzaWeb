        ...
        <div class="content">
            ...
            <div class="account-info">
                <div class="indiv-info">
                    ...
                    <p class="acc-info-content">Angelo</p>
                </div>
                <div class="indiv-info">
                    <p class="acc-info-title">Last Name:</p>
                    <p class="acc-info-content">Echano</p>
                </div>
                <div class="indiv-info">
                    <p class="acc-info-title">Email Address:</p>
                    <p class="acc-info-content">angelo.echano@example.ca</p>
                </div>
                <div class="indiv-info">
                ...
                <div class="indiv-info">
                    ...
                    <p class="acc-info-content">123 Main Street, Red Deer, AB T4N 2R2, Canada</p>
                </div>
                <div class="indiv-info">
                </div>
            </div>
