...
<div class="box">
      <p> E-mail : <span><?= $fetch_accounts['custEmail']; ?></span> </p>
      <p> Customer ID : <span><?= $fetch_accounts['customerID']; ?></span> </p>
      <a href="emais.php?delete=<?= $fetch_accounts['custEmail']; ?>" onclick="return confirm('delete this account?')" class="delete-btn">delete</a>
   </div>
